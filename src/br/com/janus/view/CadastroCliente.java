...
public class CadastroCliente extends JPanel {
	...
	public CadastroCliente() throws ParseException {
		...
		btnVerificar.addActionListener(a -> {
			...
			//TODO paraFabioDeFabio: reverificar e reescrever essa "l�gica" -> funciona, mas t� mal organizado o c�digo.			
			try{
				Long.parseLong(cpf);
			}catch (Exception e) {
				cpf = "";
	...
	private boolean verificaCamposValidos() {
		if (this.textFieldNome.getText().equals("") || this.textFieldTelefone.getText().equals("") || this.textFieldTelefone.getText().equals("(  )     -    ")
	...
	private void dadosInvalidos() {
		JOptionPane.showMessageDialog(null, "CPF/CNPJ inv�lido! Por favor, tente novamente.");
	}
	//
	...
	public void preencheDadosCliente(ClienteJuridico cliente, Endereco endereco) {
		if (cliente != null) {
			lblCadastroDeClientes.setText("Edi��o de Cliente");
			lblCadastroDeClientes.repaint();
